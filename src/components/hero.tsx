  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[1] flex flex-col pointer-events-none">
        ...
        <div className="flex justify-end px-5 pt-5 md:px-10 md:pt-10">
          <a
            href="#solutions"
        ...
        <div className="flex-1 flex items-center justify-center">
          <h1
            ...
            style={{ fontSize: "clamp(3rem, 10vw, 8rem)", fontWeight: 600, lineHeight: 1.05, letterSpacing: "-0.02em", textAlign: "center", color: "#111111" }}
          >
            Vernon
            <br />
            Family
        ...
        {/* Bottom bar */}
        <div className="flex flex-col gap-4 px-5 pb-5 md:flex-row md:justify-between md:items-end md:px-10 md:pb-10">
          <p
