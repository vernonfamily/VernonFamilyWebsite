      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
          ...
          >
            ...
            <p className="font-[family-name:var(--font-inter)]" style={{ fontSize: "1rem", lineHeight: 1.8, color: "rgba(255,255,255,0.5)", maxWidth: "480px", marginBottom: "3rem" }}>
            ...
            <a
              ...
              style={{ display: "block", fontSize: "0.95rem", fontWeight: 500, color: "white", textDecoration: "none", marginBottom: "0.75rem" }}
            >
            ...
            <a
              ...
              className="font-[family-name:var(--font-inter)]"
              style={{ display: "block", fontSize: "0.95rem", fontWeight: 500, color: "white", textDecoration: "none", marginBottom: "2rem" }}
            >
              +27 81 484 6068
            </a>
            ...
            <div style={{ display: "flex", gap: "1rem" }}>
              <a
                ...
                aria-label="LinkedIn"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "44px", height: "44px", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "50%", textDecoration: "none" }}
              >
