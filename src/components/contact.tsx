        ...
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "end" }}>
          ...
          >
            ...
            <a
              ...
              style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(0,0,0,0.08)", paddingBottom: "1.5rem", paddingTop: "1.5rem", textDecoration: "none", color: "inherit" }}
            >
              <div>
            ...
            <div style={{ display: "flex", gap: "1.5rem", paddingTop: "1.5rem" }}>
              <a
                ...
                aria-label="LinkedIn"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "48px", height: "48px", border: "1px solid rgba(0,0,0,0.1)", borderRadius: "50%", textDecoration: "none" }}
              >
